 ...
 */
OandaAdapter.prototype.subscribeEvents = function (accountIds, listener, context) {
...
OandaAdapter.prototype._streamEvents = function (accountIds) {
    ...
    this.eventsRequest = httpClient.sendRequest({
            ...
            method: "GET",
            path: `/v1/events?accountIds=${accountIds}`,
            headers: {
...
OandaAdapter.prototype.getTransactions = function (accountId, callback) {
